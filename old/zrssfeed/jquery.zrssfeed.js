...
(function($){
	...
	var _process = function(e, data, options) {
		...
		for (var i=options.offset; i<feeds.entries.length; i++) {
			...
			rowArray[rowIndex]['html'] = '<'+ options.titletag +'>ddddddddd<a href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'">'+ entry.title +'dfafdsf</a></'+ options.titletag +'>'
			...
			if (options.content) {
				...
				if (options.linkcontent) {
					content = '<a href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'">'+ content +'dfdsafsfds</a>'
				}
		...
		$.each(rowArray, function(e) {
			...
			html += '<li class="rssRow '+row+'">' + rowArray[e]['html'] + 'vv</li>';
